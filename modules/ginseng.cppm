...
namespace _detail {
    ...
    template<typename T> class optional<deny<T>>
    {
      public:
        static_assert(false_t<T>::value,
          "Optional deny parameters not allowed.");
    };
    ...
    template<typename DB> struct database_traits
    {
        ...
        class visitor_key<primary<Primary>, Coms...>
        {
          ...
          private:
            ...
            type_guid guids[sizeof...(Coms)] = {
                get_type_guid<com_t<Coms>>()...
            };
        };
        ...
        template<typename... Components> struct visitor_traits_impl
        {
            ...
            auto
              apply(DB &db, ent_id eid, com_id primary_cid, Visitor &&visitor)
            {
                if (key.check(db, eid))
                {
          ...
          private:
              ...
              primary<Primary>)
            {
                ...
                {
                    return db.template get_component_by_id<Com>(
                      primary_cid, guid);
                } else
                {
              ...
              primary<Primary>)
            {
                ...
                return get_com_optional<inner_component>(inner_category{},
                  db,
                  eid,
                  primary_cid,
                  guid,
        ...
        size_type assign(size_type entid, T com)
        {
            ...
            if (index == back_index)
            {
                if (bucket == buckets.size())
                {
                    ...
                    comid_to_entid.resize(
                      comid_to_entid.size() + bucket_size, null_id);
                }
    ...
    class database
    {
      public:
        ...
        template<typename Visitor> void visit(Visitor &&visitor)
        {
            ...
            return visit_helper(
              std::forward<Visitor>(visitor), primary_component{});
        }
      ...
      private:
                  ...
                  get_com_set<Component>(traits.template get_guid<Component>()))
            {
                ...
                for (com_id cid = 0, sz = com_set.capacity(); cid < sz; ++cid)
                {
                    if (com_set.is_valid(cid))
                    {
                        ...
                        traits.apply(
                          *this, { i, entities[i].version }, cid, visitor);
                    }
                }
            }
        }
        ...
        void visit_helper(Visitor &&visitor, primary<void>)
        {
            ...
            for (auto i = 0u; i < entities.size(); ++i)
            {
                ...
                {
                    traits.apply(
                      *this, { i, entities[i].version }, {}, visitor);
                }
            }
        }
