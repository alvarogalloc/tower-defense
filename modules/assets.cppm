...
export
{
    ...
    class assets
    {
        ...
        template <typename T> using hash_map = std::unordered_map<std::string_view, ptr<T>>;
      ...
      public:
        ...
        {
            static_assert(std::is_same_v<T, sf::Texture> || std::is_same_v<T, sf::Music> || std::is_same_v<T, sf::Font>,
