...
#pragma clang diagnostic ignored "-Wdeprecated"
  ...
  public:
    ...
    struct get_primary<DB, HeadCom, Components...> {
      ...
      using type = std::conditional_t<
        std::is_same_v<category, component_tags::normal>, primary<HeadCom>,
    ...
    public:
        ...
        {
          return (
            check<Coms>(db, eid, get_guid(index_of_v<com_t<Coms>, com_t<Coms>...>), tag_t<Coms> {})
            && ...);
        }
    ...
    private:
        ...
        template <typename Com>
        static bool check(
          [[maybe_unused]] DB& db, [[maybe_unused]] ent_id eid, [[maybe_unused]] type_guid guid,
          component_tags::meta)
        {
          return true;
        }
        ...
        auto apply(DB& db, ent_id eid, com_id primary_cid, Visitor&& visitor)
        {
          if (key.check(db, eid)) {
            return std::forward<Visitor>(visitor)(get_com<Components>(
              tag_t<Components> {}, db, eid, primary_cid, get_guid<Components>(),
              primary_component {})...);
          }
        }
    ...
    private:
        ...
        static Com& get_com(
          component_tags::normal, DB& db, const ent_id& eid, const com_id& primary_cid,
        ...
        template <typename Com, typename Primary>
        static Com get_com(
          component_tags::optional, DB& db, const ent_id& eid, const com_id& primary_cid,
          type_guid guid, primary<Primary>)
        {
        ...
        template <typename Com, typename Primary>
        static const ent_id& get_com(
          component_tags::eid, [[maybe_unused]] DB& db, const ent_id& eid,
        ...
        template <typename Com, typename Primary>
        static Com get_com(
          component_tags::unit, [[maybe_unused]] DB& db, [[maybe_unused]] const ent_id& eid,
          [[maybe_unused]] const com_id& primary_cid, [[maybe_unused]] type_guid guid,
          primary<Primary>)
        {
          return {};
  ...
  public:
     ...
     */
      ...
      {
        static_assert(
          sizeof(void*) >= sizeof(ent_id::index_type), "Pointer conversion not possible");
