...
{
    if (str == "no_space")
        return layout_flags::no_space;
    if (str == "fill_space")
        return layout_flags::fill_space;
    if (str == "space_between")
        return layout_flags::space_between;
    if (str == "space_around")
        return layout_flags::space_around;
...
{
    if (str == "left")
        return h_alignment::left;
    if (str == "right")
        return h_alignment::right;
    if (str == "center")
        return h_alignment::center;
